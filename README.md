...
- [Shouldly](https://github.com/shouldly/shouldly/labels/Jump-In) _(label: Jump-In)_ <br> Should testing for .NET - the way Asserting *Should* be!
 [Legerity](https://github.com/MADE-Apps/legerity/labels/good%20first%20issue) _(label: the first issue)_ <br> A framework ehich is used for boosten up the development of automated UI tests for Windows, Android, iOS, and Web with Appium/Selenium on .NET.
